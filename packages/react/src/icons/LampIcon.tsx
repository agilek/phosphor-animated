...
const WEIGHTS: IconWeights = {
  ...
  duotone: <><polygon points="64 40 192 40 240 152 16 152 64 40" opacity="0.2" fill="currentColor"/><polygon points="64 40 192 40 240 152 16 152 64 40" strokeWidth="16" className="draw-line" pathLength={1} style={{animationDelay:"0s"}}/><line strokeWidth="16" className="draw-line" pathLength={1} style={{animationDelay:"0.3s"}}/><line strokeWidth="16" className="draw-line" pathLength={1} style={{animationDelay:"0.6s"}}/><line strokeWidth="16" className="draw-line" pathLength={1} style={{animationDelay:"0.9s"}}/></>,
};
