...
const WEIGHTS: IconWeights = {
  ...
  duotone: <><path d="M128,112V24H112A56,56,0,0,0,56,80v32Z" opacity="0.2" fill="currentColor"/><rect x="56" y="24" width="144" height="208" rx="56" strokeWidth="16" className="draw-line" style={{animationDelay:"0s"}}/><line strokeWidth="16" className="draw-line" style={{animationDelay:"0.3s"}}/><line strokeWidth="16" className="draw-line" style={{animationDelay:"0.6s"}}/></>,
};
