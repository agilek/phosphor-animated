...
const WEIGHTS: IconWeights = {
  ...
  duotone: <><rect x="64" y="40" width="128" height="200" rx="16" opacity="0.2" fill="currentColor"/><polyline points="128 168 144 136 112 136 128 104" strokeWidth="16" className="draw-line" pathLength={1} style={{animationDelay:"0s"}}/><line strokeWidth="16" className="draw-line" pathLength={1} style={{animationDelay:"0.3s"}}/><rect x="64" y="40" width="128" height="200" rx="16" strokeWidth="16" className="draw-line" pathLength={1} style={{animationDelay:"0.6s"}}/></>,
};
