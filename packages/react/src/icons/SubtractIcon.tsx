...
const WEIGHTS: IconWeights = {
  ...
  duotone: <><path d="M167.6,88.4h0A73.37,73.37,0,0,1,168,96a72,72,0,0,1-72,72,73.37,73.37,0,0,1-7.6-.4h0a72,72,0,1,0,79.2-79.2Z" opacity="0.2" fill="currentColor"/><circle cx="96" cy="96" r="72" strokeWidth="16" className="draw-line" style={{animationDelay:"0s"}}/><path d="M167.6,88.4a72,72,0,1,1-79.2,79.2" strokeWidth="16" className="draw-line" style={{animationDelay:"0.3s"}}/></>,
};
