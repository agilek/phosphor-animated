...
const WEIGHTS: IconWeights = {
  ...
  duotone: <><path d="M128,208V48h72a8,8,0,0,1,8,8V200a8,8,0,0,1-8,8Z" opacity="0.2" fill="currentColor"/><rect x="48" y="48" width="160" height="160" rx="8" strokeWidth="16" className="draw-line"/><line strokeWidth="16" className="draw-line"/></>,
};
