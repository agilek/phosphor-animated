...
const WEIGHTS: IconWeights = {
  thin: <><circle cx="128" cy="120" r="8" fill="currentColor"/><circle cx="84" cy="120" r="8" fill="currentColor"/><circle cx="172" cy="120" r="8" fill="currentColor"/><path d="M105.07,192l16,28a8,8,0,0,0,13.9,0l16-28H216a8,8,0,0,0,8-8V56a8,8,0,0,0-8-8H40a8,8,0,0,0-8,8V184a8,8,0,0,0,8,8Z" strokeWidth="8" className="draw-line" pathLength={1} style={{animationDelay:"0s"}}/></>,
  light: <><circle cx="128" cy="120" r="10" fill="currentColor"/><circle cx="84" cy="120" r="10" fill="currentColor"/><circle cx="172" cy="120" r="10" fill="currentColor"/><path d="M105.07,192l16,28a8,8,0,0,0,13.9,0l16-28H216a8,8,0,0,0,8-8V56a8,8,0,0,0-8-8H40a8,8,0,0,0-8,8V184a8,8,0,0,0,8,8Z" strokeWidth="12" className="draw-line" pathLength={1} style={{animationDelay:"0s"}}/></>,
  regular: <><circle cx="128" cy="120" r="12" fill="currentColor"/><circle cx="84" cy="120" r="12" fill="currentColor"/><circle cx="172" cy="120" r="12" fill="currentColor"/><path d="M105.07,192l16,28a8,8,0,0,0,13.9,0l16-28H216a8,8,0,0,0,8-8V56a8,8,0,0,0-8-8H40a8,8,0,0,0-8,8V184a8,8,0,0,0,8,8Z" strokeWidth="16" className="draw-line" pathLength={1} style={{animationDelay:"0s"}}/></>,
  bold: <><circle cx="104" cy="120" r="16" fill="currentColor"/><circle cx="152" cy="120" r="16" fill="currentColor"/><path d="M105.07,192l16,28a8,8,0,0,0,13.9,0l16-28H216a8,8,0,0,0,8-8V56a8,8,0,0,0-8-8H40a8,8,0,0,0-8,8V184a8,8,0,0,0,8,8Z" strokeWidth="24" className="draw-line" pathLength={1} style={{animationDelay:"0s"}}/></>,
