...
const WEIGHTS: IconWeights = {
  ...
  bold: <><circle cx="104" cy="120" r="16" fill="currentColor"/><circle cx="152" cy="120" r="16" fill="currentColor"/><path d="M105.07,192l16,28a8,8,0,0,0,13.9,0l16-28H216a8,8,0,0,0,8-8V56a8,8,0,0,0-8-8H40a8,8,0,0,0-8,8V184a8,8,0,0,0,8,8Z" strokeWidth="24" className="draw-line" style={{animationDelay:"0s"}}/></>,
