...
const WEIGHTS: IconWeights = {
  thin: <><line strokeWidth="8" className="draw-line" style={{animationDelay:"0s"}}/><rect x="116" y="100" width="112" height="56" rx="8" transform="translate(300 -44) rotate(90)" strokeWidth="8" className="draw-line" style={{animationDelay:"0.3s"}}/><rect x="56" y="72" width="56" height="152" rx="8" strokeWidth="8" className="draw-line" style={{animationDelay:"0.6s"}}/></>,
  light: <><line strokeWidth="12" className="draw-line" style={{animationDelay:"0s"}}/><rect x="116" y="100" width="112" height="56" rx="8" transform="translate(300 -44) rotate(90)" strokeWidth="12" className="draw-line" style={{animationDelay:"0.3s"}}/><rect x="56" y="72" width="56" height="152" rx="8" strokeWidth="12" className="draw-line" style={{animationDelay:"0.6s"}}/></>,
  regular: <><line strokeWidth="16" className="draw-line" style={{animationDelay:"0s"}}/><rect x="116" y="100" width="112" height="56" rx="8" transform="translate(300 -44) rotate(90)" strokeWidth="16" className="draw-line" style={{animationDelay:"0.3s"}}/><rect x="56" y="72" width="56" height="152" rx="8" strokeWidth="16" className="draw-line" style={{animationDelay:"0.6s"}}/></>,
  bold: <><line strokeWidth="24" className="draw-line" style={{animationDelay:"0s"}}/><rect x="122" y="106" width="104" height="52" rx="8" transform="translate(306 -42) rotate(90)" strokeWidth="24" className="draw-line" style={{animationDelay:"0.3s"}}/><rect x="56" y="80" width="52" height="144" rx="8" strokeWidth="24" className="draw-line" style={{animationDelay:"0.6s"}}/></>,
