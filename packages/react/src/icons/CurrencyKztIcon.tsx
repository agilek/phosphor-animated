...
const WEIGHTS: IconWeights = {
  ...
  duotone: <><rect x="56" y="56" width="144" height="40" opacity="0.2" fill="currentColor"/><line strokeWidth="16" className="draw-line"/><line strokeWidth="16" className="draw-line"/><line strokeWidth="16" className="draw-line"/></>,
};
