...
const WEIGHTS: IconWeights = {
  ...
  light: <><circle cx="52" cy="236" r="10" fill="currentColor"/><circle cx="84" cy="204" r="10" fill="currentColor"/><circle cx="20" cy="204" r="10" fill="currentColor"/><circle cx="52" cy="172" r="10" fill="currentColor"/><path d="M248,40H216L184,72,161.91,201.31a8,8,0,0,1-13.54,4.34l-98-98a8,8,0,0,1,4.34-13.54L184,72" strokeWidth="12" className="draw-line" pathLength={1} style={{animationDelay:"0s"}}/></>,
  regular: <><circle cx="52" cy="236" r="12" fill="currentColor"/><circle cx="84" cy="204" r="12" fill="currentColor"/><circle cx="20" cy="204" r="12" fill="currentColor"/><circle cx="52" cy="172" r="12" fill="currentColor"/><path d="M248,40H216L184,72,161.91,201.31a8,8,0,0,1-13.54,4.34l-98-98a8,8,0,0,1,4.34-13.54L184,72" strokeWidth="16" className="draw-line" pathLength={1} style={{animationDelay:"0s"}}/></>,
  bold: <><circle cx="52" cy="236" r="16" fill="currentColor"/><circle cx="84" cy="204" r="16" fill="currentColor"/><circle cx="20" cy="204" r="16" fill="currentColor"/><circle cx="52" cy="172" r="16" fill="currentColor"/><path d="M244,40H216L184,72,161.91,201.31a8,8,0,0,1-13.54,4.34l-98-98a8,8,0,0,1,4.34-13.54L184,72" strokeWidth="24" className="draw-line" pathLength={1} style={{animationDelay:"0s"}}/></>,
