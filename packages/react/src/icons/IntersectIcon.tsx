...
const WEIGHTS: IconWeights = {
  thin: <><circle cx="96" cy="96" r="72" strokeWidth="8" className="draw-line" style={{animationDelay:"0s"}}/><circle cx="160" cy="160" r="72" strokeWidth="8" className="draw-line" style={{animationDelay:"0.3s"}}/><line strokeWidth="8" className="draw-line" style={{animationDelay:"0.6s"}}/><line strokeWidth="8" className="draw-line" style={{animationDelay:"0.9s"}}/></>,
  light: <><circle cx="96" cy="96" r="72" strokeWidth="12" className="draw-line" style={{animationDelay:"0s"}}/><circle cx="160" cy="160" r="72" strokeWidth="12" className="draw-line" style={{animationDelay:"0.3s"}}/><line strokeWidth="12" className="draw-line" style={{animationDelay:"0.6s"}}/><line strokeWidth="12" className="draw-line" style={{animationDelay:"0.9s"}}/></>,
  regular: <><circle cx="96" cy="96" r="72" strokeWidth="16" className="draw-line" style={{animationDelay:"0s"}}/><circle cx="160" cy="160" r="72" strokeWidth="16" className="draw-line" style={{animationDelay:"0.3s"}}/><line strokeWidth="16" className="draw-line" style={{animationDelay:"0.6s"}}/><line strokeWidth="16" className="draw-line" style={{animationDelay:"0.9s"}}/></>,
  bold: <><circle cx="96" cy="96" r="72" strokeWidth="24" className="draw-line" style={{animationDelay:"0s"}}/><circle cx="160" cy="160" r="72" strokeWidth="24" className="draw-line" style={{animationDelay:"0.3s"}}/><line strokeWidth="24" className="draw-line" style={{animationDelay:"0.6s"}}/></>,
