...
const WEIGHTS: IconWeights = {
  ...
  duotone: <><path d="M32,208a8,8,0,0,1-5.66-13.66L160,60.7V208Z" opacity="0.2" fill="currentColor"/><path d="M200,200a8,8,0,0,1-8,8H32a8,8,0,0,1-5.66-13.66l160-160A8,8,0,0,1,200,40Z" strokeWidth="16" className="draw-line" pathLength={1} style={{animationDelay:"0s"}}/><line strokeWidth="16" className="draw-line" pathLength={1} style={{animationDelay:"0.3s"}}/></>,
};
