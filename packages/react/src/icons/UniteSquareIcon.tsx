...
const WEIGHTS: IconWeights = {
  ...
  duotone: <><polygon points="96 216 216 216 216 96 160 96 160 40 40 40 40 160 96 160 96 216" opacity="0.2" fill="currentColor"/><polygon points="96 216 216 216 216 96 160 96 160 40 40 40 40 160 96 160 96 216" strokeWidth="16" className="draw-line" style={{animationDelay:"0s"}}/></>,
};
