...
const WEIGHTS: IconWeights = {
  ...
  fill: <><path d="M198.12,25.23a16,16,0,0,0-17.44,3.46l-160,160A16,16,0,0,0,32,216H192a16,16,0,0,0,16-16V40A15.94,15.94,0,0,0,198.12,25.23ZM192,200H128V104l64-64Z" fill="currentColor"/></>,
  duotone: <><path d="M32,208a8,8,0,0,1-5.66-13.66L120,100.7V208Z" opacity="0.2" fill="currentColor"/><path d="M200,200a8,8,0,0,1-8,8H32a8,8,0,0,1-5.66-13.66l160-160A8,8,0,0,1,200,40Z" strokeWidth="16" className="draw-line"/><line strokeWidth="16" className="draw-line"/></>,
};
