...
const WEIGHTS: IconWeights = {
  ...
  light: <><circle cx="156" cy="172" r="10" fill="currentColor"/><circle cx="92" cy="164" r="10" fill="currentColor"/><circle cx="84" cy="108" r="10" fill="currentColor"/><circle cx="132" cy="124" r="10" fill="currentColor"/><path d="M224,128a48,48,0,0,1-48-48,48,48,0,0,1-48-48,96,96,0,1,0,96,96Z" strokeWidth="12" className="draw-line" pathLength={1} style={{animationDelay:"0s"}}/></>,
  regular: <><circle cx="156" cy="172" r="12" fill="currentColor"/><circle cx="92" cy="164" r="12" fill="currentColor"/><circle cx="84" cy="108" r="12" fill="currentColor"/><circle cx="132" cy="124" r="12" fill="currentColor"/><path d="M224,128a48,48,0,0,1-48-48,48,48,0,0,1-48-48,96,96,0,1,0,96,96Z" strokeWidth="16" className="draw-line" pathLength={1} style={{animationDelay:"0s"}}/></>,
  bold: <><circle cx="156" cy="172" r="16" fill="currentColor"/><circle cx="92" cy="164" r="16" fill="currentColor"/><circle cx="84" cy="108" r="16" fill="currentColor"/><circle cx="132" cy="124" r="16" fill="currentColor"/><path d="M224,128a48,48,0,0,1-48-48,48,48,0,0,1-48-48,96,96,0,1,0,96,96Z" strokeWidth="24" className="draw-line" pathLength={1} style={{animationDelay:"0s"}}/></>,
